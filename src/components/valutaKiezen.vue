  ...
  methods: {
    async verkrijgData() {
      try {
        ...
        this.conversieRatio = data.conversion_rates[this.tweedeValuta];
        this.berekenConversie(); 
      } catch (error) {
    ...
    berekenConversie() {
      if (this.bedrag != null && this.conversieRatio != null) {
        this.geconverteerdBedrag = (this.bedrag * this.conversieRatio).toFixed(2);
      }
    }
  },
